...
import org.mozilla.osmdroid.ResourceProxy.bitmap;
...
public class ItemizedIconOverlay<Item extends OverlayItem> extends ItemizedOverlay<Item> {
	...
	public ItemizedIconOverlay(
			...
			final org.mozilla.osmdroid.views.overlay.ItemizedIconOverlay.OnItemGestureListener<Item> pOnItemGestureListener,
